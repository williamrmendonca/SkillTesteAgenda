...
const StartedInProgressScheduleAppointmentIntentHandler = {
  ...
  async handle(handlerInput) {
    ...
    if (appointmentDate.value && appointmentTime.value) {
      ...
      const speakDateTimeLocal = luxon.DateTime.fromISO(dateTimeLocal).setLocale('pt-BR').toFormat("' dia' dd 'de' LLLL 'de' yyyy 'às' HH':'mm 'horas'"); //dateTimeLocal.toLocaleString(luxon.DateTime.DATETIME_SHORT);
...
// ================================================================================================================================
// Lida com a conclusão de um compromisso. Este manipulador é usado quando o diálogo em ScheduleAppointmentIntent é concluído.
// ================================================================================================================================
// Handles the completion of an appointment. This handler is used 
// when dialog in ScheduleAppointmentIntent is completed.
...
// ================================================================================================================================
// Este manipulador é usado para lidar com casos em que um usuário pergunta se um horário de compromisso está disponível
// ================================================================================================================================
